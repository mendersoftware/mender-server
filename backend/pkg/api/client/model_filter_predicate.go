...
func NewFilterPredicate(scope Scope, attribute string, type_ string, value AttributeValueRequest) *FilterPredicate {
...
func (o *FilterPredicate) GetValue() AttributeValueRequest {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *FilterPredicate) GetValueOk() (*AttributeValueRequest, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Value, true
...
func (o *FilterPredicate) SetValue(v AttributeValueRequest) {
	o.Value = v
}
