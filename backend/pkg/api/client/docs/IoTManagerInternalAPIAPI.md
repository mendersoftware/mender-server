...
> IoTManagerInternalProvisionDevice(ctx, tenantId).NewDeviceInternalProvision(newDeviceInternalProvision).Execute()
...
func main() {
	tenantId := "tenantId_example" // string | ID of tenant the device belongs to.
	newDeviceInternalProvision := *openapiclient.NewNewDeviceInternalProvision("Id_example") // NewDeviceInternalProvision | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.IoTManagerInternalAPIAPI.IoTManagerInternalProvisionDevice(context.Background(), tenantId).NewDeviceInternalProvision(newDeviceInternalProvision).Execute()
	if err != nil {
 ...
 **newDeviceInternalProvision** | [**NewDeviceInternalProvision**](NewDeviceInternalProvision.md) |  | 
