...
func main() {
	attribute := []openapiclient.Attribute{*openapiclient.NewAttribute("Name_example", openapiclient.Attribute_value{ArrayOfFloat32: new([]float32)})} // []Attribute | A list of attribute descriptors.
