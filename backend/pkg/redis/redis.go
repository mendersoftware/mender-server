...
// Invalidates a cache entry by swapping it with a temporary short-lived entry.
...
// Retrieves a cache entry. If the temporary value is found, returns `ErrCacheInvalid`
