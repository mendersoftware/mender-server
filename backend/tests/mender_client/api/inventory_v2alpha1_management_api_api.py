...
class InventoryV2alpha1ManagementAPIApi:
    ...
    @validate_call
    def search_inventory_by_identity(
        self,
        search_identity_params: Annotated[Optional[SearchIdentityParams], Field(description="Identity search parameters")] = None,
        ...
        _param = self._search_inventory_by_identity_serialize(
            search_identity_params=search_identity_params,
    ...
    @validate_call
    def search_inventory_by_identity_with_http_info(
        self,
        search_identity_params: Annotated[Optional[SearchIdentityParams], Field(description="Identity search parameters")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def search_inventory_by_identity_without_preload_content(
        self,
        search_identity_params: Annotated[Optional[SearchIdentityParams], Field(description="Identity search parameters")] = None,
        _request_timeout: Union[
            None,
    ...
    def _search_inventory_by_identity_serialize(
        self,
        search_identity_params,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if search_identity_params is not None:
            _body_params = search_identity_params
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/management/v2alpha1/inventory/identities/search',
