...
class DeviceInventoryDeviceAPIApi:
    ...
    def assign_attributes(
        self,
        device_attribute_request: Annotated[List[DeviceAttributeRequest], Field(description="A list of attribute descriptors.")],
        ...
        :param device_attribute_request: A list of attribute descriptors. (required)
        :type device_attribute_request: List[DeviceAttributeRequest]
        ...
        _param = self._assign_attributes_serialize(
            device_attribute_request=device_attribute_request,
    ...
    def _assign_attributes_serialize(
        ...
        if device_attribute_request is not None:
            _body_params = device_attribute_request
