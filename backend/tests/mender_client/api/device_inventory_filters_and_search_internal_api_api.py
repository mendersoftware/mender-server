...
class DeviceInventoryFiltersAndSearchInternalAPIApi:
    ...
    def get_statistics_internal(
        ...
        _param = self._get_statistics_internal_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def get_statistics_internal_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_statistics_internal_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant ID.")],
        _request_timeout: Union[
            None,
    ...
    def _get_statistics_internal_serialize(
        self,
        tenant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/internal/v2/inventory/tenants/{tenant_id}/statistics",
    ...
    def inventory_internal_v2_search_device_inventories(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant ID.")],
        inventory_internal_v2_search_device_inventories_request: Annotated[
            Optional[InventoryInternalV2SearchDeviceInventoriesRequest],
