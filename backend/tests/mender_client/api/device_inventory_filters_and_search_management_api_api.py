...
class DeviceInventoryFiltersAndSearchManagementAPIApi:
    ...
    def get_filterable_attributes(
        ...
        Returns a list of filterable inventory attributes.  The list is sorted in descending order by the count of occurrences of the attribute in the inventory database, then in ascending order by scope and name.  Limitations:  * The API considers up to a sample of 5,000 devices when aggregating the number of attributes.  * The API returns up to 500 unique attributes.
        ...
        _param = self._get_filterable_attributes_serialize(
    ...
    @validate_call
    def get_filterable_attributes_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[FilterAttribute]]:
        """Get the list of filterable inventory attributes
    ...
    @validate_call
    def get_filterable_attributes_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_filterable_attributes_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/management/v2/inventory/filters/attributes",
    ...
    def _get_statistics_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/management/v2/inventory/statistics",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def inventory_v2_search_device_inventories(
        self,
        inventory_v2_search_device_inventories_request: Annotated[
            Optional[InventoryV2SearchDeviceInventoriesRequest],
            Field(description="The search and sort parameters of the filter"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _inventory_v2_search_device_inventories_serialize(
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/api/management/v2/inventory/filters/search",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
