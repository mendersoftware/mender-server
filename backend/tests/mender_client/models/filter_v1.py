...
class FilterV1(BaseModel):
    """
    Filter built based on devices targeted by the deployment. 
    """ # noqa: E501
    terms: List[AttributeFilterPredicate]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FilterV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FilterV1 from a dict"""
        if obj is None:
            return None
