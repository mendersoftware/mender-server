...
class ReleaseV2(BaseModel):
    ...
    artifacts: Optional[List[ArtifactV2]] = Field(default=None, description="List of artifacts for this release.")
    ...
    __properties: ClassVar[List[str]] = ["name", "modified", "artifacts", "tags", "notes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "artifacts": [ArtifactV2.from_dict(_item) for _item in obj["artifacts"]] if obj.get("artifacts") is not None else None,
            "tags": obj.get("tags"),
            "notes": obj.get("notes")
        })
        return _obj
