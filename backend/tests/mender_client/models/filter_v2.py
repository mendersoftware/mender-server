...
class FilterV2(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier of the saved filter. ")
    name: StrictStr = Field(description="Name of the saved filter. ")
    terms: Optional[List[AttributeFilterPredicate]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "terms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "terms": [AttributeFilterPredicate.from_dict(_item) for _item in obj["terms"]] if obj.get("terms") is not None else None
        })
        return _obj
