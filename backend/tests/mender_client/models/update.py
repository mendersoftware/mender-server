...
class Update(BaseModel):
    ...
    meta_data: Optional[List[Dict[str, Any]]] = Field(
        default=None,
        description="Deprecated: Please use `metadata` instead. A list of objects of unknown structure as this is dependent of update type (also custom defined by user) ",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "type_info": (
                    ArtifactTypeInfo.from_dict(obj["type_info"])
                    if obj.get("type_info") is not None
                    else None
                ),
                "files": (
                    [UpdateFile.from_dict(_item) for _item in obj["files"]]
