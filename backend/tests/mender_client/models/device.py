...
class Device(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        default=None, description="Mender assigned Device ID."
    )
    identity_data: Optional[IdentityData] = None
    status: Optional[StrictStr] = None
    created_ts: Optional[datetime] = Field(
        default=None, description="Created timestamp"
    )
    ...
    decommissioning: Optional[StrictBool] = Field(
        default=None,
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('pending', 'accepted', 'rejected', 'preauthorized', 'noauth')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "identity_data": (
                    IdentityData.from_dict(obj["identity_data"])
                    if obj.get("identity_data") is not None
                    else None
                ),
