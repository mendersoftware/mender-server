...
class DeviceAuthEvent(BaseModel):
    ...
    status: Optional[StrictStr] = Field(
        default=None, description="The authentication status of the device."
    )
    auth_sets: Optional[List[AuthSet]] = None
    created_ts: Optional[datetime] = Field(
        default=None, description="The time the device was initialized in Mender."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "auth_sets": (
                    [AuthSet.from_dict(_item) for _item in obj["auth_sets"]]
                    if obj.get("auth_sets") is not None
                    else None
                ),
