...
class Plan(BaseModel):
    ...
    name: StrictStr = Field(description="Unique name of the plan. ")
    display_name: StrictStr = Field(description="Short information about the plan. ")
    features: Features
    __properties: ClassVar[List[str]] = ["name", "display_name", "features"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "features": (
                    Features.from_dict(obj["features"])
