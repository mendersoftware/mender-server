...
class JobObject(BaseModel):
    ...
    input_parameters: Optional[List[InputParameter]] = Field(default=None, alias="inputParameters")
    status: Optional[StrictStr] = None
    results: Optional[List[TaskResult]] = None
    insert_time: Optional[datetime] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "workflowName", "inputParameters", "status", "results", "insert_time", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JobObject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JobObject from a dict"""
        if obj is None:
            return None
