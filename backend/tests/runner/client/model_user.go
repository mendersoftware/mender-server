...
// GetLoginTs returns the LoginTs field value if set, zero value otherwise.
func (o *User) GetLoginTs() time.Time {
	if o == nil || IsNil(o.LoginTs) {
		var ret time.Time
		return ret
	}
	return *o.LoginTs
...
// GetLoginTsOk returns a tuple with the LoginTs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *User) GetLoginTsOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LoginTs) {
		return nil, false
	}
	return o.LoginTs, true
}
...
// SetLoginTs gets a reference to the given time.Time and assigns it to the LoginTs field.
