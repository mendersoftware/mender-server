...
func (s *DeploymentsManagementV1Suite) TestListArtifactsV2() {
	...
	s.Run("NamePrefixAndExactName", func() {
		require, assert := s.Require(), s.Assert()
...
func (s *DeploymentsManagementV1Suite) TestUploadArtifact() {
	s.Run("SelectionAlreadyInstalled", s.uploadArtifactSelectionAlreadyInstalled)
	s.Run("DependsProvidesValid", s.uploadArtifactDependsProvidesValid)
	s.Run("ProvidesDependsIgnoredInOpenSource", s.uploadArtifactProvidesDependsIgnoredInOpenSource)
}

func (s *DeploymentsManagementV1Suite) uploadArtifactSelectionAlreadyInstalled() {
...
func (s *DeploymentsManagementV1Suite) uploadArtifactDependsProvidesValid() {
...
func (s *DeploymentsManagementV1Suite) uploadArtifactProvidesDependsIgnoredInOpenSource() {
