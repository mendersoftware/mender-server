...
func (s *InventoryManagementV1Suite) TestDevicePatchAttributes() {
	s.Run("Ok", s.devicePatchAttributesOk)
	s.Run("FailNoAttrValue", s.devicePatchAttributesFailNoAttrValue)
}

func (s *InventoryManagementV1Suite) devicePatchAttributesOk() {
...
func (s *InventoryManagementV1Suite) devicePatchAttributesFailNoAttrValue() {
