...
// RegisterConnectionCancelHandle provides a mock function with given fields: connID, cancel, exclusive
func (_m *App) RegisterConnectionCancelHandle(connID string, cancel context.CancelFunc, exclusive bool) uint32 {
	ret := _m.Called(connID, cancel, exclusive)
