...
from management_v1.api import ManagementAPIClient as GenManagementAPIClient
from management_v1 import (
    Configuration as mgmt_Configuration,
    ApiClient as mgmt_ApiClient,
)
from internal_v1.api import InternalAPIClient as GenInternalAPIClient
...
class ManagementAPIClient(GenManagementAPIClient):
    ...
    def set_integration_credentials(self, id, credentials, **kwargs):
        return self.io_t_manager_management_set_integration_credentials(id, credentials, **kwargs)

    def unregister_device_integrations(self, device_id, **kwargs):
        return self.io_t_manager_management_unregister_device_integrations(device_id, **kwargs)
    ...
    def replace_state(self, device_id, integration_id, **kwargs):
        return self.io_t_manager_management_replace_state(device_id, integration_id, **kwargs)

    def get_device_state(self, device_id, integration_id, **kwargs):
        return self.io_t_manager_management_get_device_state(device_id, integration_id, **kwargs)
...
class InternalAPIClient(GenInternalAPIClient):
    ...
    def provision_device(self, tenant_id, new_device, **kwargs):
        return self.io_t_manager_internal_provision_device(tenant_id, new_device, **kwargs)
    ...
    def decommission_device(self, tenant_id, device_id, **kwargs):
        return self.io_t_manager_internal_decommission_device(tenant_id, device_id, **kwargs)

    def update_device_statuses(self, tenant_id, status, request_body, **kwargs):
        return self.io_t_manager_internal_update_device_statuses(tenant_id, status, request_body, **kwargs)
