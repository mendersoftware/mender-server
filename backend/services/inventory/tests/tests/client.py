...
class InternalApiClient:
    ...
    def create_tenant(self, tenant_id):
        ...
        result, status, headers = self.client.inventory_internal_create_tenant_with_http_info(tenant_new=tenant)
    ...
    def create_device(self, device_id, attributes, description="test device"):
        ...
        result, status, headers = self.client.initialize_device_with_http_info(tenant_id="", device_new=device)
        return Response(status_code=status, data=result)
