...
import (
	...
	user "github.com/mendersoftware/mender-server/pkg/common/user"
...
func (_m *App) Login(ctx context.Context, email user.Email, pass string, options *useradm.LoginOptions) (*jwt.Token, error) {
	...
	var r0 *jwt.Token
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, user.Email, string, *useradm.LoginOptions) (*jwt.Token, error)); ok {
		return rf(ctx, email, pass, options)
	}
	if rf, ok := ret.Get(0).(func(context.Context, user.Email, string, *useradm.LoginOptions) *jwt.Token); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, user.Email, string, *useradm.LoginOptions) error); ok {
