...
// GetActiveDeploymentIDsByArtifactNames provides a mock function with given fields: ctx, artifactNames
func (_m *DataStore) GetActiveDeploymentIDsByArtifactNames(ctx context.Context, artifactNames []string) ([]string, error) {
	ret := _m.Called(ctx, artifactNames)

	if len(ret) == 0 {
		panic("no return value specified for GetActiveDeploymentIDsByArtifactNames")
	}
...
// GetTenantDbs provides a mock function with no fields
...
func (_m *DataStore) ListSoftwareTags(ctx context.Context, filter *model.SoftwareTagsFilter) (model.Tags, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ListSoftwareTags")
	}

	var r0 model.Tags
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *model.SoftwareTagsFilter) (model.Tags, error)); ok {
		return rf(ctx, filter)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *model.SoftwareTagsFilter) model.Tags); ok {
		r0 = rf(ctx, filter)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(model.Tags)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *model.SoftwareTagsFilter) error); ok {
		r1 = rf(ctx, filter)
	} else {
		r1 = ret.Error(1)
	}
