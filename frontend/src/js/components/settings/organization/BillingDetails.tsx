...
const Address = props => {
  ...
  return (
    <div>
      <Typography style={{ fontWeight: 'bold' }} color={theme.palette.text.secondary}>
        {name}
      </Typography>
    ...
    <>
      {billing && (
        <div>
          ...
          <Button disabled={editDisabled} variant="outlined" className="margin-top-x-small" onClick={() => setChangeBilling(true)} size="medium">
            Edit
          </Button>
        </div>
      )}
