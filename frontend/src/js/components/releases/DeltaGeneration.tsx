...
import { getDeltaJobs, getIsEnterprise } from '@northern.tech/store/selectors';
...
export const DeltaProgress = ({ className = '' }) => {
  ...
  const deltaJobs = useSelector(getDeltaJobs);
  const { byId, jobIds, total, sort, page = defaultPage, perPage = defaultPerPage } = deltaJobs;
  ...
  return (
    <div className={className}>
      <h3 className="margin-bottom">Generated Delta Artifacts</h3>
      <DetailsTable
