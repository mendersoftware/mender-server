...
import { rolloutModes, rolloutPatterns } from './constants';
...
describe('CustomPhaseTable', () => {
  describe('percentage mode', () => {
    it('renders the sized phase definitions plus the derived final phase', () => {
      render(
        <FormWrapper
          defaultValues={{
    ...
    it('adds a phase when clicking the add button', async () => {
      ...
      render(
        <FormWrapper
          defaultValues={{
            phases: [{ batchSize: 10, delay: 2, delayUnit: 'hours' }],
            rolloutMode: rolloutModes.percentage.key
          }}
        >
          <CustomPhaseTable deploymentDeviceCount={100} />
        ...
        <FormWrapper
          defaultValues={{
            phases: [
              ...
              { batchSize: 30, delay: 1, delayUnit: 'hours' }
            ],
            rolloutMode: rolloutModes.percentage.key
          }}
        >
  ...
  describe('device_count mode', () => {
    ...
    it('adds a phase in device_count mode', async () => {
      ...
      render(
        <FormWrapper
          defaultValues={{
            phases: [{ batchSize: 20, delay: 2, delayUnit: 'hours' }],
            rolloutMode: rolloutModes.device_count.key
          }}
        >
          <CustomPhaseTable deploymentDeviceCount={100} />
