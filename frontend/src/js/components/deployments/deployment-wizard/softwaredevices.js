  ...
  return (
    <>
      ...
      <div ref={groupRef} className={classes.selection}>
        {deviceText ? (
          <TextField value={deviceText} label={pluralize('device', devices.length)} disabled variant="standard" className={classes.infoStyle} />
        ) : (
          <div>
            <Autocomplete
      ...
      <div className={commonClasses.columns}>
        <div ref={releaseRef} className={classes.selection}>
          {releaseSelectionLocked ? (
            <TextField value={deploymentRelease?.name} label="Release" disabled variant="standard" className={classes.infoStyle} />
          ) : (
            <AsyncAutocomplete
