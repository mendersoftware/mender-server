        ...
        <div className="flexbox space-between">
          <div className="flexbox center-aligned">
            ...
            <Button
              ...
              color="neutral"
              variant="outlined"
              className={`margin-left-small  ${advancedFilters ? classes.advancedFiltersOpened : ''}`}
              startIcon={<FilterListIcon />}
              endIcon={advancedFilters ? <ExpandLessIcon /> : <ExpandMoreIcon />}
          ...
          <form noValidate>
            {advancedFilters && (
              <div className="flexbox space-between margin-top-small">
                <div className={`flexbox column ${classes.advancedFilterContainer}`}>
            ...
            <div className="flexbox column margin-top-small margin-bottom-small">
              ...
              <ControlledSearch onSearch={() => Promise.resolve()} name="searchTerm" placeholder="Search releases..." />
            </div>
          </form>
        </FormProvider>
        <Divider />
