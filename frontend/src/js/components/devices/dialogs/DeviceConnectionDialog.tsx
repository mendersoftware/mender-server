    ...
    <>
      ...
      <div className={`margin-top-small padding-small rpi-quickstart ${classes.rpiQuickstart} ${classes.deviceSection}`}>
        ...
        <div className="flexbox margin-top-small">
          <Button variant="text" color="primary" size="small" onClick={() => setOnDevice(true)} endIcon={<ArrowForwardIcon />}>
            Get started
          </Button>
        </div>
      </div>
      <div className="two-columns margin-top-small">
        <div className={`padding-small padding-bottom-none flexbox column ${classes.deviceSection}`}>
          ...
          <div>
            <Button variant="text" size="small" color="primary" endIcon={<ArrowForwardIcon />} onClick={() => setMcu(true)}>
        ...
        <div className={`padding-small ${classes.deviceSection}`}>
          ...
          <div className="flexbox margin-top-small">
            <Button variant="text" color="primary" size="small" onClick={() => setVirtualDevice(true)} endIcon={<ArrowForwardIcon />}>
      ...
      <Typography variant="body1" className={classes.bottomText}>
        <a className={classes.link} href="https://docs.mender.io/overview/device-support" target="_blank" rel="noopener noreferrer">
