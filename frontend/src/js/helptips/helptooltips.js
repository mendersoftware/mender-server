...
const PlanUpgradeEmail = () => {
  return (
    <>
      This email address will receive all payment receipts and notifications about pricing and device limits. It does not necessarily have to belong to a user
      in your Mender account
    </>
  );
};
