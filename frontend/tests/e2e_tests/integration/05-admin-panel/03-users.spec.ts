...
test.describe('Admin panel users', () => {
  ...
  test('lists the users of every tenant by default', async ({ adminBaseUrl, page, spTenantUsername, username }) => {
  ...
  test('filters by email and clears the filter again', async ({ adminBaseUrl, page, spTenantUsername, username }) => {
    await page.goto(`${adminBaseUrl}users`);
  ...
  test('filters down to the users of a single tenant', async ({ adminBaseUrl, page, request, spTenantUsername, username }) => {
